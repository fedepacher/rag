...
class MessageData:
    def __init__(self, id: str, input: str, date: datetime, output: str, context: str, email: str):
        self.id = id
        self.input = input
        self.date = date
        self.output = output
    ...
    @property
    def json(self):
        return json.dumps({'id': self.id, 'input': self.input, 'date': self.date, 'output': self.output, 'context': self.context, 'email': self.email})
